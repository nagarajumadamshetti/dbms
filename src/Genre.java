...
public class Genre {
    ...
    public int createGenre(Genre genre, Connection connection) throws SQLException {
    ...
    public int updateGenre(Genre genre, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deleteGenre(String genreID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
