...
public class Album {
    ...
    public int createAlbum(Album album, Connection connection) throws SQLException {
    ...
    public int updateAlbum(Album album, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deleteAlbum(String albumID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted=0;
        try {
