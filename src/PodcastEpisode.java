...
public class PodcastEpisode {
    ...
    public int createPodcastEpisode(PodcastEpisode episode, Connection connection) throws SQLException {
    ...
    public int updatePodcastEpisode(PodcastEpisode episode, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deletePodcastEpisode(String podcastEpisodeID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
