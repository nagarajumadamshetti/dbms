...
public class OriginCountry {
    ...
    public int createOriginCountry(OriginCountry originCountry, Connection connection) throws SQLException {
    ...
    public int updateOriginCountry(OriginCountry originCountry, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deleteOriginCountry(String podcastID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
