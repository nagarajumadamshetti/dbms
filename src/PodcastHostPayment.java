...
public class PodcastHostPayment {
    ...
    public int createPodcastHostPayment(PodcastHostPayment podcastHostPayment, Connection connection) throws SQLException {
    ...
    public int updatePodcastHostPayment(PodcastHostPayment podcastHostPayment, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deletePodcastHostPayment(String paymentID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
