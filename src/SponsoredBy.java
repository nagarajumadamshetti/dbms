...
public class SponsoredBy {
    ...
    public int createSponsoredBy(SponsoredBy sponsoredBy, Connection connection) throws SQLException {
    ...
    public int deleteSponsoredBy(String podcastID, String sponsorID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
