...
public class CollaboratedBy {
    ...
    public int createCollaboration(CollaboratedBy collaboration, Connection connection) throws SQLException {
    ...
    public int updateCollaboration(CollaboratedBy collaboration, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deleteCollaboration(String artistID, String songID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
