...
public class GuestFeatured {
    ...
    public int createGuestFeatured(GuestFeatured guestFeatured, Connection connection) throws SQLException {
    ...
    public int updateGuestFeatured(GuestFeatured guestFeatured, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deleteGuestFeatured(String guestID, String podcastEpisodeID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
