...
public class BasedIn {
    ...
    public int createBasedIn(BasedIn basedIn, Connection connection) throws SQLException {
    ...
    public int updateBasedIn(BasedIn basedIn, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deleteBasedIn(String artistID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
