...
public class User {
    ...
    public int createUser(User user, Connection connection) throws SQLException {
    ...
    public int updateUser(User user, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deleteUser(String userID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
