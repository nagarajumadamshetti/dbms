...
public class Received {
    ...
    public int createReceived(Received received, Connection connection) throws SQLException {
    ...
    public int updateReceived(Received received, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deleteReceived(String paymentID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
