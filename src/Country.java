...
public class Country {
    ...
    public int createCountry(Country country, Connection connection) throws SQLException {
    ...
    public int updateCountry(Country country, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deleteCountry(int countryID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
