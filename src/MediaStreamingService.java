...
public class MediaStreamingService {
    ...
    public int createMediaStreamingService(MediaStreamingService mediaStreamingService, Connection connection) throws SQLException {
    ...
    public int updateMediaStreamingService(MediaStreamingService mediaStreamingService, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deleteMediaStreamingService(String ID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
