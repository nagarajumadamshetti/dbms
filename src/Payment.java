...
public class Payment {
    ...
    public int createPayment(Payment payment, Connection connection) throws SQLException {
    ...
    public int updatePayment(Payment payment, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
