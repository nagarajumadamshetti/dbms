...
public class MonthlyListeners {
    ...
    public int createMonthlyListeners(MonthlyListeners monthlyListeners, Connection connection) throws SQLException {
    ...
    public int updateMonthlyListeners(MonthlyListeners monthlyListeners, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated =0;
        try {
    ...
    public int deleteMonthlyListeners(String artistID, Date date, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
