...
public class SubscribeArtist {
    ...
    public int createSubscription(SubscribeArtist subscription, Connection connection) throws SQLException {
    ...
    public int updateSubscription(String userID, String artistID, String newUserID, String newArtistID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deleteSubscription(String userID, String artistID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
