...
public class SungIn {
	...
	public int createSungIn(SungIn sungIn, Connection connection) throws SQLException {
	...
	public int updateSungIn(SungIn sungIn, Connection connection) throws SQLException {
		PreparedStatement statement = null;
		int isUpdated = 0;
		try {
	...
	public int deleteSungIn(String songID, Connection connection) throws SQLException {
		PreparedStatement statement = null;
		int isDeleted = 0;
		try {
