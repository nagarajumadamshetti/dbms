...
public class SubscribePodcast {
    ...
    public int createSubscribePodcast(SubscribePodcast subscribePodcast, Connection connection) throws SQLException {
    ...
    public int updateSubscribePodcast(SubscribePodcast subscribePodcast, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deleteSubscribePodcast(String userID, String podcastID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
