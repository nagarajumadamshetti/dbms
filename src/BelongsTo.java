...
public class BelongsTo {
    ...
    public int createBelongsTo(BelongsTo belongsTo, Connection connection) throws SQLException {
    ...
    public int updateBelongsTo(BelongsTo belongsTo, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deleteBelongsTo(String songID, String albumID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
