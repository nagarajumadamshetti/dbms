...
public class ArtistPayments {
    ...
    public int createPayment(ArtistPayments payment, Connection connection) throws SQLException {
    ...
    public int updatePayment(ArtistPayments payment, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
