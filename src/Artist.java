...
public class Artist {
    ...
    public int createArtist(Artist artist, Connection connection) throws SQLException {
    ...
    public int updateArtist(Artist artist, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deleteArtist(String artistID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted=0;
        try {
