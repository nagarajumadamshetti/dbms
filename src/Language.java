...
public class Language {
    ...
    public int createLanguage(Language language, Connection connection) throws SQLException {
    ...
    public int updateLanguage(Language language, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
    ...
    public int deleteLanguage(String languageID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
