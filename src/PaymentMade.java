...
public class PaymentMade {
    ...
    public int createPaymentMade(PaymentMade paymentMade, Connection connection) throws SQLException {
    ...
    public int updatePaymentMade(PaymentMade paymentMade, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deletePaymentMade(String userID, String paymentID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
