...
public class OwnedBy {
    ...
    public int createOwnedBy(OwnedBy ownedBy, Connection connection) throws SQLException {
    ...
    public int updateOwnedBy(OwnedBy ownedBy, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deleteOwnedBy(String podcastID, String podcastHostID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
