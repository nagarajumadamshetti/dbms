...
public class PodcastHost {
    ...
    public int createPodcastHost(PodcastHost podcastHost, Connection connection) throws SQLException {
    ...
    public PodcastHost readPodcastHost(String podcastHostID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
    ...
    public int updatePodcastHost(PodcastHost podcastHost, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deletePodcastHost(String podcastHostID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
