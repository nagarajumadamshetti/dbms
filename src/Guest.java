...
public class Guest {
    ...
    public int createGuest(Guest guest, Connection connection) throws SQLException {
    ...
    public int updateGuest(Guest guest, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deleteGuest(String guestID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
