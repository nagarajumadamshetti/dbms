...
public class PodcastGeneredIn {
    ...
    public int createPodcastGeneredIn(PodcastGeneredIn podcastGeneredIn, Connection connection) throws SQLException {
    ...
    public int updatePodcastGeneredIn(PodcastGeneredIn podcastGeneredIn, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deletePodcastGeneredIn(String podcastID, String genreID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
