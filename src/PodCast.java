...
public class Podcast {
    ...
    public int createPodcast(Podcast podcast, Connection connection) throws SQLException {
    ...
    public Podcast readPodcast(String podcastID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
    ...
    public int updatePodcast(Podcast podcast, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deletePodcast(String podcastID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
