...
public class Sponsor {
    ...
    public int createSponsor(Sponsor sponsor, Connection connection) throws SQLException {
    ...
    public int updateSponsor(Sponsor sponsor, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isUpdated = 0;
        try {
    ...
    public int deleteSponsor(String sponsorID, Connection connection) throws SQLException {
        PreparedStatement statement = null;
        int isDeleted = 0;
        try {
